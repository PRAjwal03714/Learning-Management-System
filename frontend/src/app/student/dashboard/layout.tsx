    ...
    <div className="flex h-screen w-screen overflow-hidden">
      ...
      <header className="fixed top-0 left-0 w-full h-20 bg-white border-b border-gray-200 shadow-md z-50 flex items-center justify-between px-6">
        <div className="flex items-center gap-3">
          <div className="bg-red-700 text-white rounded-full w-10 h-10 flex items-center justify-center text-sm font-bold">SM</div>
          <Link href="/student/dashboard" className="text-3xl font-extrabold text-red-700 tracking-tight">
            StudyMate
          </Link>
        </div>
